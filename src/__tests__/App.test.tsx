...
jest.mock('../components/Sidebar', () => {
  return function MockSidebar({ page, onChange }: { page: string; onChange: (page: string) => void }) {
...
jest.mock('../components/SettingsTab', () => {
  return function MockSettingsTab({ darkMode, onToggleDarkMode }: { darkMode: boolean; onToggleDarkMode: () => void }) {
...
jest.mock('../components/ScrollableContainer', () => {
  return function MockScrollableContainer({ id, className, children }: { 
    id?: string; 
    className?: string; 
...
jest.mock('../components/KeyboardHelpDialog', () => {
  return function MockKeyboardHelpDialog({ isOpen, onClose }: { 
    isOpen: boolean; 
    onClose: () => void;
    shortcuts?: unknown;
  }) {
...
describe('App', () => {
  ...
  it('should navigate between tabs', async () => {
    ...
    const collectButton = container.querySelector('[data-testid="nav-collect"]') as HTMLButtonElement
    flushSync(() => {
      collectButton.click()
    })
    ...
    const settingsButton = container.querySelector('[data-testid="nav-settings"]') as HTMLButtonElement
    flushSync(() => {
  ...
  it('should handle dark mode toggle', async () => {
    ...
    // Toggle dark mode
    const darkModeToggle = container.querySelector('[data-testid="dark-mode-toggle"]') as HTMLButtonElement
    flushSync(() => {
