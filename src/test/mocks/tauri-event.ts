...
export const listen = jest.fn().mockImplementation((event: string, handler: (event: unknown) => void) => {
...
export const once = jest.fn().mockImplementation((event: string, handler: (event: unknown) => void) => {
