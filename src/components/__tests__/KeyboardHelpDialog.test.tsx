...
describe('KeyboardHelpDialog', () => {
  ...
  test('should not render when isOpen is false', () => {
    flushSync(() => {
      root.render(React.createElement(KeyboardHelpDialog, {
        isOpen: false,
        onClose: mockOnClose,
  ...
  test('should group shortcuts by category', () => {
    ...
    const categories = Array.from(sections).map(section => 
      section.querySelector('.keyboard-help-category')?.textContent
    );
  ...
  test('should handle shortcuts without category (default to General)', () => {
    ...
    const generalSection = Array.from(container.querySelectorAll('.keyboard-help-category'))
      .find(category => category.textContent === 'General');
