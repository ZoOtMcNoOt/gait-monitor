...
describe('MetadataForm', () => {
  ...
  describe('Form Validation', () => {
    ...
    test('should have proper validation functions for session name', () => {
      ...
      expect(validateSessionName('A'.repeat(101))).toBe(
        'Session name must be less than 100 characters',
      )
    ...
    test('should have proper validation functions for subject ID', () => {
      ...
      expect(validateSubjectId('SUBJ@01')).toBe(
        'Subject ID can only contain letters, numbers, hyphens, and underscores',
      )
  ...
  describe('Component Integration', () => {
        ...
        return React.createElement(
          ...
          React.createElement('input', {
            ...
            onChange: (e: React.ChangeEvent<HTMLInputElement>) =>
              handleFieldUpdate('sessionName', e.target.value),
          }),
          React.createElement('input', {
            'data-testid': 'subject-id',
            value: fieldValues.subjectId,
            onChange: (e: React.ChangeEvent<HTMLInputElement>) =>
              handleFieldUpdate('subjectId', e.target.value),
          }),
    ...
    test('should test validation functions directly', () => {
      ...
      expect(testValidateSessionName('a'.repeat(101))).toBe(
        'Session name must be less than 100 characters',
      )
      expect(testValidateSessionName('Test@Session!')).toBe(
      ...
      expect(testValidateSubjectId('a'.repeat(51))).toBe(
        'Subject ID must be less than 50 characters',
      )
      expect(testValidateSubjectId('SUBJ@001')).toBe(
        'Subject ID can only contain letters, numbers, hyphens, and underscores',
      )
  ...
  describe('Field Validation and Interactions', () => {
    test('should handle field value changes', () => {
      const TestComponent = () => {
        ...
        return React.createElement(
          ...
          {},
          React.createElement(MetadataForm, {
            onSubmit: (data: { sessionName: string; subjectId: string; notes: string }) =>
    ...
    test('should handle validateField function behavior', () => {
      ...
      expect(validateField('notes', 'A'.repeat(1001))).toBe(
    ...
    test('should handle complex validation scenarios', () => {
      ...
      expect(subjectValidation('SUBJ 001')).toBe(
        'Subject ID can only contain letters, numbers, hyphens, and underscores',
      )
    })
      ...
      const TestMetadataState = () => {
        ...
        return React.createElement(
          ...
          React.createElement('input', {
            ...
            onChange: (e: React.ChangeEvent<HTMLInputElement>) =>
              handleFieldChange('sessionName', e.target.value),
          }),
          React.createElement(
            'div',
            {
        ...
        return React.createElement(
          ...
          React.createElement(
            'button',
            {
              ...
              onClick: () =>
                validateForm({ sessionName: 'Test', subjectId: 'SUBJ001', notes: 'Notes' }),
            },
            'Validate Valid',
          ),
          validationResult &&
