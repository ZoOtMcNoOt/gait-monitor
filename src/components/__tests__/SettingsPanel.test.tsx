...
describe('SettingsPanel', () => {
  ...
  test('renders Dark Theme checkbox', async () => {
    ...
    const darkThemeCheckbox = Array.from(container.querySelectorAll('input[type="checkbox"]'))
      .find(input => input.parentElement?.textContent?.includes('Dark Theme'));
  ...
  test('renders Chart Smoothing checkbox', async () => {
    ...
    const smoothingCheckbox = Array.from(container.querySelectorAll('input[type="checkbox"]'))
      .find(input => input.parentElement?.textContent?.includes('Chart Smoothing'));
  ...
  test('renders Auto-Reconnect checkbox', async () => {
    ...
    const reconnectCheckbox = Array.from(container.querySelectorAll('input[type="checkbox"]'))
      .find(input => input.parentElement?.textContent?.includes('Auto-Reconnect'));
