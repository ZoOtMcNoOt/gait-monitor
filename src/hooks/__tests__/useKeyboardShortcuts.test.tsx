...
import { createCommonShortcuts, useKeyboardShortcuts, useFocusTrap, useTabNavigation } from '../useKeyboardShortcuts';
...
function TestTabNavigationComponent({ 
  ...
  return React.createElement('div', { 'data-testid': 'tab-navigation-test' }, 
    React.createElement('button', null, 'Button 1'),
    React.createElement('button', null, 'Button 2'),
    React.createElement('input', { type: 'text' }),
...
describe('useKeyboardShortcuts Hook', () => {
  ...
  test('handles action errors gracefully', (done) => {
    ...
    const errorAction = () => { throw new Error('Test error'); };
    const shortcuts = [
      { key: 'Enter', description: 'Error shortcut', action: errorAction }
    ];
...
describe('useFocusTrap Hook', () => {
  ...
  test('traps focus within container', (done) => {
    flushSync(() => {
      root.render(React.createElement(TestFocusTrapComponent, {
        onHookReady: (containerRef) => {
...
describe('useTabNavigation Hook', () => {
  ...
  test('provides navigation functions', (done) => {
    flushSync(() => {
      root.render(React.createElement(TestTabNavigationComponent, {
        onHookReady: (hook) => {
